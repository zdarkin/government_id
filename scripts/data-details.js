...
const idDetails = {
  "philsys": {
    ...
    processingTime: "Instant (Digital ePhilID) | 3 to 9+ months (Physical Card)",
    eligibility: [
    ...
    reminder: "The PhilSys ID registration is completely free. Establishment owners are legally mandated to accept both the physical card and the digital ePhilID via eGovPH app. Do not pay any fees."
  },
  "passport": {
    ...
    processingTime: "12-15 working days (Regular) | 6-8 working days (Expedite)",
    eligibility: [
    ...
    reminder: "Ensure you book only via official dfa.gov.ph. Senior citizens, PWDs, pregnant women, and solo parents can use the Courtesy Lane without prior appointments."
  },
  "voter-id": {
    ...
    reminder: "Always bring small change for local municipal fees if applicable. If your registration is deactivated, you must file for reactivation during registration periods."
  },
  "sss-umid": {
    ...
    reminder: "Existing legacy UMID cards without smart chips remain valid. The new MySSS card functions as both a premium ID and a banking card."
  },
  "gsis-id": {
    ...
    eligibility: [
      "Active government employees and GSIS pensioners"
    ],
    requirements: [
    ...
    reminder: "Physical UMID card production for GSIS has been discontinued. Members are encouraged to use the GSIS Digital ID in the GSIS Touch app."
  },
  "philhealth": {
    name: "PhilHealth ID",
    ...
    reminder: "Your Member Data Record (MDR) can be downloaded online and is also accepted alongside the ID to avail of medical discounts."
  },
  "tin-id": {
    ...
    reminder: "Taxpayers are permitted only ONE TIN. BIR has fully transitioned to the Digital TIN ID; physical card distribution at RDOs is restricted."
  },
  "pagibig-loyalty": {
    ...
    reminder: "Upgrade your old non-chip card to Loyalty Card Plus. Keep the card active: UnionBank-powered cards are subject to dormancy rules if unused for 2 years."
  },
  "drivers-license": {
    ...
    reminder: "The digital e-Driver's License inside your LTMS account is officially recognized by traffic enforcers. Do not drive without carrying your physical card or logging into your LTMS account."
  },
  "prc-id": {
    name: "PRC ID / Professional Identification Card",
    tagline: "ID for state-regulated professionals (engineers, teachers, nurses)",
    ...
    eligibility: [
      "Licensed professionals who passed state board examinations"
    ],
    requirements: [
    ...
    reminder: "Ensure your CPD records are updated or use the CPD Undertaking form. PRC operates on a strict appointment-only policy."
  },
  "ibp-id": {
    name: "IBP ID",
    ...
    reminder: "Keep your membership in good standing. The QR code on modern IBP IDs can be scanned to check active legal status instantly."
  },
  "seamans-book": {
    ...
    eligibility: [
      "Filipino seafarers, maritime graduates, and crew members"
    ],
    requirements: [
    ...
    reminder: "Book your appointment weeks in advance. First-time issuances are free for graduates of maritime academies under specific government rules."
  },
  "firearms-license": {
    ...
    reminder: "Discounts of 50% are available for active government personnel and 20% for senior citizens."
  },
  "senior-citizen": {
    ...
    reminder: "Establishments are legally required to accept your Senior Citizen ID. Establishments must also honor the digital NSCID available via eGovPH app."
  },
  "pwd-id": {
    ...
    reminder: "General physicians may not sign medical certificates for invisible disabilities (e.g. autism, psychiatric disorders) — must be signed by a specialized physician."
  },
  "ofw-id": {
    ...
    reminder: "Do not pay anyone for this card. The digital card in the OWWA app is free and holds full legality."
  },
  "solo-parent": {
    name: "Solo Parent ID",
    ...
    reminder: "You must renew your Solo Parent ID yearly. Cohabiting or marrying void Solo Parent benefits immediately."
  },
  "acr-card": {
    name: "ACR I-Card",
    ...
    reminder: "Foreigners holding ACR I-Cards must file their Annual Report within the first 60 days of every calendar year (Jan 1 to Mar 1)."
  },
  "nbi-clearance": {
    name: "NBI Clearance",
    ...
    reminder: "Walk-ins are generally rejected at major NBI centers. Ensure you pay online and secure an appointment reference first."
  },
  "police-clearance": {
    ...
    eligibility: [
      "Any individual seeking police record check clearance"
    ],
    requirements: [
    ...
    reminder: "Ensure your profile matches your IDs exactly. Some renewals can be done online without visiting the police station."
  },
  "barangay-clearance": {
    ...
    eligibility: [
      "Any resident of the barangay for at least 6 months"
    ],
    requirements: [
    ...
    reminder: "Free of charge for first-time job seekers who present a Barangay First-Time Job Seeker certification."
  },
  "postal-id": {
    name: "Postal ID",
    ...
    reminder: "If applying under your married name, you must provide your PSA Marriage Certificate. Check PHLPost updates for active capture stations."
  },
  "school-id": {
    name: "Student ID",
    ...
    reminder: "Must be signed by the school principal or registrar to be valid for outside government transactions. Combine it with a birth certificate for best validity."
  },
  "company-id": {
    name: "Company ID",
    ...
    eligibility: [
      "Regular or contractual employees of a registered company"
    ],
    requirements: [
    ...
    reminder: "Not all agencies accept company IDs for high-value transactions. They are more readily accepted if the company is regulated by BSP, SEC, or IC."
  }
};
